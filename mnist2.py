...
print(
    "On train loss={0:.4f}, accuracy={1:.2%}".format(*score(model, train_dl, device))
)  # 0.1896, 93.39%
print(
    "On val   loss={0:.4f}, accuracy={1:.2%}".format(*score(model, val_dl, device))
)  # 0.2752, 90.01%
print(
    "On test  loss={0:.4f}, accuracy={1:.2%}".format(*score(model, test_dl, device))
)  # 0.2996, 89.72%
