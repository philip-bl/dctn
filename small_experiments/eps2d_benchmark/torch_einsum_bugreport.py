...
result = torch.einsum(
    "qrsp,qrso,qrsn,qrsm,qrsl,qrsk,qrsj,qrsi,qrsh,qrsg,qrsf,qrse,qrsd,qrsc,qrsb,qrsa,abcdefghijklmnopt->qrst",
    *batches_of_small_cores,
    big_core
)
...
total_allocated_GiB = (
    torch.cuda.memory_stats()["allocated_bytes.all.allocated"] / 1024 / 1024 / 1024
)
...
result = torch.einsum(
    "abcdefghijklmnopt,qrsp,qrso,qrsn,qrsm,qrsl,qrsk,qrsj,qrsi,qrsh,qrsg,qrsf,qrse,qrsd,qrsc,qrsb,qrsa->qrst",
    big_core,
    *batches_of_small_cores
)
