...
from dctn.eps import eps_simple, eps_oe, eps_oe_via_padding, align, align_via_padding
...
def test_eps_single_pixel_output() -> None:
  ...
  eps_result = rearrange(eps_simple(core, input), "b () () o -> b o")
...
def test_eps_two_pixels_output() -> None:
  ...
  eps_result = eps_simple(core, input)
...
def test_eps_slicing_and_padding_versions_give_the_same_output() -> None:
  ...
  result_via_slicing = eps_oe(core, input)
  ...
  result_via_padding = eps_oe_via_padding(core, input)
